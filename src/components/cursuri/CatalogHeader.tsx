...
export default function CatalogHeader({
  ...
  return (
    <header className="flex flex-col items-center gap-3.5 bg-[#f8f9fa] px-4 pb-8 pt-16 lg:gap-5 lg:pb-[50px] lg:pt-[150px]">
      ...
      <p className="max-w-[350px] text-center text-[14px] leading-[21px] text-[#959595] lg:max-w-none lg:text-[17px] lg:leading-normal">
        Live, practitioner-led training — certified through PECB, delivered on Google Meet.
      </p>

      {/* Quiz CTA — butonul principal al paginii */}
      <div className="flex flex-col items-center gap-3.5 lg:gap-2 lg:pt-2.5">
        <p className="text-[14px] text-[#959595]">Not sure where to start?</p>
        <a
          href={quizHref}
