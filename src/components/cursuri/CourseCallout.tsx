...
export default function CourseCallout({ locale }: { locale: Locale }) {
  ...
  return (
    <section className="pb-16 lg:pb-[110px]">
      <Container className="flex w-full flex-wrap gap-5 lg:gap-6">
        <Link
          href={localePath(locale, '/corporate')}
          className="flex min-w-[300px] flex-1 flex-col gap-2.5 rounded-[24px] bg-gradient-to-br from-steel to-blue px-7 py-6 shadow-[3px_9px_24px_rgba(28,93,153,0.18)] transition-transform hover:scale-[1.01] lg:px-9 lg:py-[30px]"
        >
          ...
          <p className="text-[13.5px] leading-5 text-[#e1edf7] lg:text-[15px] lg:leading-normal">
            {t.calloutTeamBody} →
          </p>
        </Link>
        <Link
          href={localePath(locale, '/contact')}
          className="flex min-w-[300px] flex-1 flex-col gap-2.5 rounded-[24px] border-[6px] border-line-soft bg-white px-7 py-6 shadow-[3px_9px_20px_rgba(77,77,77,0.03)] transition-transform hover:scale-[1.01] lg:px-9 lg:py-[30px]"
        >
