...
export default function ContactHeader({
  ...
  return (
    <header className="flex flex-col items-center gap-3 px-5 pt-16 lg:gap-3.5 lg:px-4 lg:pt-20">
      ...
      <h1 className="max-w-[350px] text-center text-[28px] font-semibold leading-[34px] tracking-[-1px] text-[#222222] lg:max-w-[640px] lg:text-[54px] lg:leading-[59.4px] lg:tracking-[-1.5px]">
        {titlePlain}{' '}
      ...
      <p className="max-w-[350px] text-center text-[14px] leading-[21px] text-[#959595] lg:max-w-[640px] lg:text-[16px] lg:leading-normal">
        {subtitle}
      </p>
    </header>
  )
