...
const en = {
  ...
  hero: {
    ...
    cert: {
      ...
      courseSubtitle: 'Artificial Intelligence Management Systems',
      // The hero fan (owner 2026-08-15): each card carries its own participant + course.
      cards: {
        left: { name: 'Daniel Morgan', course: 'ISO/IEC 42001 Foundation' },
        center: { name: 'Sophie Bennett', course: 'ISO/IEC 42001 Lead Auditor' },
        right: { name: 'Laura Dinca', course: 'ISO/IEC 42001 Lead Implementer' },
      },
    },
  },
  home: {
...
const ro: Dictionary = {
  ...
  hero: {
    ...
    cert: {
      ...
      completed: 'a absolvit cu succes',
      trainer: 'Dr. Silviu Gresoi',
      trainerLabel: 'Trainer',
      participantLabel: 'Participant',
      // Titulatura oficială a standardului + numele cursurilor PECB rămân în engleză.
      courseSubtitle: 'Artificial Intelligence Management Systems',
      cards: {
        left: { name: 'Daniel Morgan', course: 'ISO/IEC 42001 Foundation' },
        center: { name: 'Sophie Bennett', course: 'ISO/IEC 42001 Lead Auditor' },
