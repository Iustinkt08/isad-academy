...
const en = {
  ...
  ourCourses: {
    ...
    enroll: 'Enroll',
    whichCourse: 'Which course is right for me?',
    soldOut: 'Sold out',
  ...
  catalog: {
    ...
    subtitle: 'Live, practitioner-led training — certified through PECB, delivered on Google Meet.',
  ...
  courseDetail: {
    ...
    discountsNote:
      '3+ seats → −10% group discount. Member & promo codes apply at checkout — discounts stack.',
  ...
  corporate: {
    ...
    form: {
      ...
      successMessage: 'Your request has been sent. We’ll reply by email with a proposal for your team.',
    },
    aside: {
      nextTitle: 'What happens next',
      steps: [
        'We review your needs and reply by email.',
        'We propose the format, dates and pricing.',
        'We deliver — live on Google Meet or on-site.',
      ],
      talkTitle: 'Prefer to talk directly?',
      talkNote: 'Mon–Fri · we reply by email',
    },
  },
  about: {
    metaTitle: 'About us',
    ...
    approachCards: [
      {
        ...
        text: 'Every session happens live on Google Meet — you can ask, challenge and dig deeper in the moment.',
      },
      {
  ...
  blog: {
    ...
    hoursLive: (n: number) => `${n} hours · Live on Google Meet`,
    viewCourse: 'View course',
    inboxTitle: 'Get new articles in your inbox',
    inboxSub: 'One email when we publish — no spam, unsubscribe anytime.',
    leadMagnet: {
      title: 'Get the resource',
      intro: 'We’ll email you the download link.',
  ...
  legal: {
    ...
    deliveryMetaDescription:
      'How isad.academy courses are delivered — live online sessions on Google Meet — followed by the full Terms & Conditions.',
  ...
  notFound: {
    ...
    body: 'The page you are looking for doesn’t exist or has moved. It might have been an old course edition or an unpublished article.',
  ...
  newsletter: {
    ...
    confirmedBody:
      'Thanks for confirming your email address — you are now subscribed to the isad.academy newsletter. We will let you know about new courses, articles and certification updates.',
    backHome: 'Back to home',
  },
  checkout: {
    metaTitle: 'Checkout',
    ...
    liveOnMeet: 'Live on Google Meet',
    dayCount: (n: number) => (n === 1 ? '1 day' : `${n} days`),
    ...
    participantEmailPlaceholder: 'Email — receives the Meet invite',
    ...
    buyerEmailPlaceholder: 'Email — order confirmation & invoice',
    phoneLabel: 'Phone (optional)',
    phonePlaceholder: 'Phone',
    ...
    errorEnterValidEmail: 'Please enter a valid email address.',
    ...
    editionLine: (date: string) => `Edition ${date} · Live on Google Meet`,
    ...
    trustInvoice: 'Invoice issued automatically after payment.',
    trustInvite: 'Meet invite arrives by email before the start date.',
    whatHappensNext: 'What happens next',
    nextStepPay: 'Pay & get your confirmation email',
    nextStepInvoice: 'Receive the invoice automatically',
    nextStepJoin: 'Join the live sessions on Google Meet',
    ...
    noOrderMessage:
      "We couldn't find a recent enrolment in this browser session. If you just paid, check your email for the confirmation.",
    ...
    meetInviteNote:
      'Your Google Meet invite will follow a few days before the course starts. Each participant receives it at the email address above.',
  ...
  meta: {
    ...
    siteDescription:
      'Expert-led live courses that prepare you for ISO/IEC 42001:2023, taught one-to-one on Google Meet.',
  },
  newsletterForm: {
    emailLabel: 'Email address',
    subscribe: 'Subscribe',
...
const ro: Dictionary = {
  ...
  ourCourses: {
    ...
    enroll: 'Înscrie-te',
    whichCourse: 'Ce curs mi se potrivește?',
  ...
  catalog: {
    ...
    subtitle: 'Training live, susținut de un practician — certificat prin PECB, livrat pe Google Meet.',
  ...
  courseDetail: {
    ...
    standardLabel: 'Standard',
    discountsNote:
      '3+ locuri → −10% reducere de grup. Codurile de membru și cele promoționale se aplică la checkout — reducerile se cumulează.',
  ...
  corporate: {
    ...
    form: {
      ...
      successMessage: 'Cererea ta a fost trimisă. Îți răspundem pe email cu o ofertă pentru echipa ta.',
    },
    aside: {
      nextTitle: 'Ce urmează',
      steps: [
        'Analizăm nevoile voastre și răspundem pe email.',
        'Propunem formatul, datele și prețul.',
        'Livrăm — live pe Google Meet sau la sediul vostru.',
      ],
      talkTitle: 'Preferi să vorbim direct?',
      talkNote: 'Luni–vineri · răspundem pe email',
    },
  },
  about: {
    ...
    approachCards: [
      {
        ...
        text: 'Fiecare sesiune are loc live pe Google Meet — poți întreba, contrazice și aprofunda pe loc.',
      },
      {
  ...
  blog: {
    ...
    emptySubtitle: 'Abonează-te și îți trimitem articolele noi direct pe email.',
    ...
    hoursLive: (n: number) => `${n} ore · Live pe Google Meet`,
    viewCourse: 'Vezi cursul',
    inboxTitle: 'Primește articolele noi pe email',
    inboxSub: 'Un singur email când publicăm — fără spam, te poți dezabona oricând.',
    leadMagnet: {
      title: 'Obține resursa',
      intro: 'Îți trimitem linkul de descărcare pe email.',
  ...
  legal: {
    ...
    deliveryMetaDescription:
      'Cum sunt livrate cursurile isad.academy — sesiuni live online pe Google Meet — urmate de Termenii și condițiile complete.',
  ...
  notFound: {
    ...
    body: 'Pagina pe care o cauți nu există sau a fost mutată. E posibil să fi fost o ediție de curs mai veche sau un articol nepublicat.',
    browseCourses: 'Vezi cursurile',
    readBlog: 'Citește blogul',
  ...
  newsletter: {
    ...
    confirmedBody:
      'Îți mulțumim că ți-ai confirmat adresa de email — ești acum abonat(ă) la newsletterul isad.academy. Te anunțăm despre cursuri noi, articole și noutăți legate de certificare.',
    backHome: 'Înapoi acasă',
  },
  checkout: {
    ...
    liveOnMeet: 'Live pe Google Meet',
    ...
    participantEmailPlaceholder: 'Email — primește invitația Meet',
    ...
    buyerEmailPlaceholder: 'Email — confirmarea comenzii și factura',
    phoneLabel: 'Telefon (opțional)',
    phonePlaceholder: 'Telefon',
    ...
    errorEnterValidEmail: 'Te rugăm să introduci o adresă de email validă.',
    ...
    editionLine: (date: string) => `Ediția din ${date} · Live pe Google Meet`,
    windowNames: { earlyBird: 'Early Bird', standard: 'Standard' },
    ...
    trustInvoice: 'Factura se emite automat după plată.',
    trustInvite: 'Invitația Meet sosește pe email înainte de data de început.',
    whatHappensNext: 'Ce urmează',
    nextStepPay: 'Plătești și primești emailul de confirmare',
    nextStepInvoice: 'Primești factura automat',
    nextStepJoin: 'Participi la sesiunile live pe Google Meet',
    ...
    noOrderMessage:
      'Nu am găsit o înscriere recentă în această sesiune de browser. Dacă tocmai ai plătit, verifică emailul pentru confirmare.',
    ...
    pricingHeading: 'Preț',
    meetInviteNote:
      'Invitația ta Google Meet va sosi cu câteva zile înainte de începerea cursului. Fiecare participant o primește la adresa de email de mai sus.',
  ...
  meta: {
    ...
    siteDescription:
      'Cursuri live susținute de experți, care te pregătesc pentru ISO/IEC 42001:2023 — predate unu-la-unu pe Google Meet.',
  },
  newsletterForm: {
    emailLabel: 'Adresa de email',
