 ...
 * underline/strikethrough runs, links, bullet/numbered lists, line breaks and horizontal
 * rules. Anything else (uploads, blocks, embeds) is skipped rather than half-rendered —
 * a silently broken layout in someone's inbox is worse than an omission, and the editor
 * description tells the author which formatting actually ships.
 */
