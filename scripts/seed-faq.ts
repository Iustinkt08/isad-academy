...
const FAQ: { category: Category; q: string; a: string; qRo: string; aRo: string }[] = [
  ...
  },
  {
    ...
    aRo: 'Simplu: o oră de învățare înseamnă un credit CPD. Un curs de 35 de ore îți aduce 35 de credite CPD, menționate pe certificat și recunoscute pentru dezvoltarea ta profesională continuă.',
  },
  {
    category: 'validate',
